...
# Final Air-gap Package Creator with Container Images
set -e

echo "=========================================="
echo "SDC Final Air-gap Package Creator"
echo "Including container images, source code, and dependencies"
echo "=========================================="

# Configuration
PROJECT_ROOT="/mnt/usb/sdc_i"
PACKAGE_DIR="/mnt/usb/sdc_complete_package"
...
tar -czf "$FINAL_PACKAGE" "$(basename "$PACKAGE_DIR")"
