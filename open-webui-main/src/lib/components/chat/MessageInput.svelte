<script lang="ts">
	...
	const getCommand = () => {
		...
		if (chatInput && chatInputElement?.getWordAtDocPos) {
					...
					{:else}
						...
						>
							<div
								...
								class="flex-1 flex flex-col relative w-full dark:text-gray-100"
								...
								<div class=" flex justify-between items-end mt-0.5 mb-2.5 mx-0.5 w-full" dir="ltr">
									<div class="ml-1 self-end flex items-center gap-2 shrink-0">
										...
										{#if atSelectedModel !== undefined}
											<div class="flex items-center gap-1.5 px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded-full">
												<img
												...
												/>
												<span class="text-xs text-gray-700 dark:text-gray-300">{atSelectedModel.name}</span>
												<button
